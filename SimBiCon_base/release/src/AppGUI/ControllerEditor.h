...
protected:
	// this file is to write the data to compare
	int count = 0;
	ofstream myfile;
	DynamicArray<Vector3d> footPos; // save the foot position to draw
	DynamicArray<Point3d> footPoint; // save the foot center of mass to draw
